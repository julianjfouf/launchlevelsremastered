...
const ServiceRight = ({ number, title, points}) => {
  return (
    <div className="text-[#e2e2e2] flex flex-col before:z-0 items-end relative before:bg-[#e2e2e2]/10 before:absolute lg:before:h-[1200px] lg:before:w-[1200px] before:w-[600px] before:h-[600px] before:rounded-full before:top-1/2 before:-translate-y-1/2 before:left-1/2 before:-translate-x-1/2">
