...
const Testimonials = () => {
  return (
    <div className="py-24 pt-36 lg:px-24 px-12 w-full overflow-hidden">
      ...
      <div className="z-30 flex justify-center before:z-[-1] relative before:bg-[url('/images/texture2.png')] before:absolute before:h-[1200px] before:w-[1200px] before:rounded-full before:top-1/2 before:-translate-y-1/2 before:left-1/2 before:-translate-x-1/2">
        <Testimonial
      ...
      <div className="z-30 lg:my-[400px] my-[160px] flex justify-center before:z-[-1] relative lg:before:bg-[url('/images/texture2.png')] before:absolute before:h-[1200px] before:w-[1200px] before:rounded-full before:top-1/2 before:-translate-y-1/2 before:left-1/2 before:-translate-x-1/2">
        <Testimonial
          name="Dano's Detailing"
          service="Car Detailing Website"
          link="https://danosdetailing.com"
      ...
      <div className="z-20 flex justify-center before:z-[-1] relative before:bg-[url('/images/texture2.png')] before:absolute before:h-[1200px] before:w-[1200px] before:rounded-full before:top-1/2 before:-translate-y-1/2 before:left-1/2 before:-translate-x-1/2">
        <Testimonial
          name="Dano's Detailing"
          service="Car Detailing Website"
          link="https://danosdetailing.com"
